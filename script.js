...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ========================================================
     ANSWER CHECK SYSTEM
     - First 5 attempts: free
     - Attempt 6+: -5 points each
     - Correct check: case-insensitive
  ======================================================== */
  ...
  // Update the 5 dots to reflect attempt state
  function updateDots() {
  ...
  // Update the text below the dots
    ...
    if (nameCorrect && locCorrect) {
      ...
      if (attemptCount < FREE_ATTEMPTS) {
        ...
        showFeedback('feedback-penalty',
          ...
          ' Penalty deducted: <strong>−' + PENALTY_PTS + ' pts</strong> · Total: <strong style="color:#c0392b">−' + penalty + ' pts</strong>.'
        );
      }
      updateAttemptInfo();
    }
